        ...
        <div id="id01" class="modal" >
            <div class="pop poppart" style="height:450px; margin-top:0;" >
                <form action="addpart.php" method="post">
                    <input type="text" name="partno" placeholder="part no" onkeyup="partId();" required autocomplete ='off'>
                    <input type="text" name="partname" placeholder="part name " required autocomplete ='off'>
                    <input type="text" name="count" placeholder="count of part" required autocomplete ='off'>
                    <input type="text" name="price" placeholder="price" required autocomplete ='off'>
                    <input type="text" name="mno" placeholder="merchant id" onkeyup="mnoId();" required autocomplete ='off'>
                    <input type="text" name="mname" placeholder="merchant name" required autocomplete ='off'>
                    <input type="text" name="phone" placeholder="merchant phone" required autocomplete ='off'>
                    <div id="downside">
