...
<head>
    <meta charset="utf-8">
    <link rel="stylesheet" type="text/css" href="..\CSS osama\infoPageStyle.css">
...
<body>
    <div class="content">
        <form  action="editemp.php" method="post" enctype="multipart/form-data">
            <div class="edit" onclick="edit();"><img src="../img/edit.png"></div>

            <div class="image">
                <?php
                if(!empty($_SESSION['img'])=="")
                {
                    echo '<img class="v" src="../img/my.png"></img>';
                }
                else
                {   
            ...
            ?>
                <span class="active"><img src="../img/plus.png" width="70%"></span>
