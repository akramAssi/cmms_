...
<head>
    ...
    // echo $_POST['message'];
            ...
            $sql = "SELECT a.name,c.brand,c.model,c.plateno,c.year,h.arrivaltime,h.deliverytime,h.no from `customer` a,`car` c,`history`h WHERE a.id=c.ownerid and c.vin=h.carvin and a.id={$_SESSION['id']} order by h.arrivaltime desc";
...
<body>
    <header>
        ...
        <input type="text" name="start" id="startDate" value="" placeholder="start date" input="searchService();" readonly/>
            ...
            <button><img src="../img/printer.png"><a id="abc" href="../print/pdf.php" style="color:#1C232C;  text-decoration: none;" target="_blank">print</a></button>
        </div>
