...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="..\CSS osama\foopicker.css">
    <script type="text/javascript" src="..\js osama\foopicker.js"></script>
    ...
    $servername = "sql302.epizy.com";
            ...
            $pl=$_GET['pl'];
            $sql="SELECT a.name,c.brand,c.model,c.plateno,c.year,h.arrivaltime,h.deliverytime,h.no from `customer` a,`car` c,`history`h WHERE a.id=c.ownerid and c.vin=h.carvin and c.plateno='{$pl}' order by h.arrivaltime desc";
...
<body>
    <header>
        ...
        <input type="text" name="search" style="width:50px;" disabled onclick="searchService();">
        <img src="../img/arrow.png" alt="arrow" id="arrow" onclick="fun()">
        <div id="connt">
        </div>
        
        <div id="cm">
        <input type="text" name="start" id="startDate" value="" placeholder="start date" input="searchService();" readonly/>
            <input type="text" name="end" id="endDate" value="" placeholder="end date" input="searchService();" readonly />
            <button><img src="../img/printer.png"><a id="abc" href="../../print/pdf.php<?php echo '?plate='.$pl ?>" style="color:#1C232C;  text-decoration: none;" target="_blank">print</a></button>
        </div>
    ...
    <script type="text/javascript">
        ...
        function searchService(){
            var searchText = "<?php echo $pl; ?>";
            document.getElementById("abc").href="../../print/pdf.php?plate="+searchText; 
