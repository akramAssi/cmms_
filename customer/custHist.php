...
<body>
	...
	<div class="d1">
		<iframe src="custHistoryPage.php"></iframe>
   </div>
<!--end right big div-->
	<div class="menu">
	<div class="secandDiv">
...
<div class="thiredDiv">
	...
	<a href="#"  title="logout" class="buttonlog">
...
<div id="myDIV">
	...
	<a href="custHomePage.php" title="Home"  class="buttonMenu">
		<img src="image\home.png" class="buttonIcon">
		<span class=" buttonText">Home</span>
	</a>
	<a href="custHist.php" title="History" class="buttonMenu act">
	...
	<a href="#" title="logout" class="buttonlogdown">
