...
$servername = "sql302.epizy.com";
        ...
        $user = $_SESSION['user'];
        $sql = "SELECT brand,model,year,plateno FROM car where ownerid = $password";
            // echo "\n".$sql;
...
<link rel="stylesheet" type="text/css" href="css\custCar.css">
</head>
...
<div class="firstDiv">
 ...
 <?php
                ...
                $conn->close();
                ?>
<img src="image\car.svg" class="img">
</div>
<script>
function openzz(pl)
{
