...
$servername = "sql302.epizy.com";
        ...
        $user = $_SESSION['user'];
        $sql = "SELECT * FROM `customer` WHERE `id`= $password AND name='{$user}'";
    ...
    <div class="content">
        <form  action="editemp.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form" >
                ...
                <div>
                    <span>ID :</span>
                    <input type="text" id="id" disabled name="id" value='<?php echo $info['id']; ?>'>
                    <!-- 4 45456445</span> -->
                </div>
                <div>
                    <span>Email :</span>
                ...
                <div>
                    ...
                    <input type="text" id="phone" name="phone" maxlength="10" disabled value='<?php echo $info['phone']; ?>' >
                    <!-- 05921358854</span> -->
                </div>
            </div>
